...
public interface BrokerPortType {
    ...
    @WebMethod
    @Oneway
    @RequestWrapper(localName = "stillAlive", targetNamespace = "http://ws.broker.upa.pt/", className = "pt.upa.broker.ws.StillAlive")
    @Action(input = "http://ws.broker.upa.pt/BrokerPort/stillAliveRequest")
    ...
    @Action(input = "http://ws.broker.upa.pt/BrokerPort/updateRequest")
    public void update(
        @WebParam(name = "updateInfo", targetNamespace = "")
        TransportView updateInfo);
